...
#define MODE_ETC_DEPOSIT                    3
#define MODE_DEPOSIT_COMPLETE               4
#define MODE_TRANSCASH                      5
#define MODE_DEPOSIT_CANCEL                 6
#define MODE_ERRORMODE                      999
#define MODE_RETURNMODE                     111
...
#define STATUS_ENABLEDATABASE    11
#define STATUS_WAITENVINPUT    12
#define STATUS_FORCECOMPLETE   13               // 강제 종료 훅알림
#define STATUS_ADDCOMPLETE   14               // 추가입금 완료
//#define STATUS_FORCECOMPWARN   14               // 강제 종료 경고 알림
#define STATUS_SERIALCOMMFAIL   15              // SDK Serial 실패
#define STATUS_ACKBARCODE     17                // 바코드 ACK
#define STATUS_ACKBULKMODE     18                // 벌크모드 확인 ACK
#define STATUS_ACKIDLECOMP     19                // 에스크로모드 확인 ACK

#define OUTGATE_EMERGENCY     20                // 아웃게이트 EMERGENCY
...
typedef struct __tagVAULTDEPOSIT_INFO{
    ...
    double preSum[12];                 // currencyUnit * currencyCount = currencySum
...
/*********************************************************************************************************************************************************************
 *cmd_fingerEnrollStart :  when assigned finger ,  Request finger scanning start
 * return: void
 *********************************************************************************************************************************************************************/
